...
router.get('/:courseId', course_controller_1.CourseController.getSingleCourse);
...
router.patch('/:id', (0, auth_1.default)(user_constant_1.USER_ROLE.admin), (0, validateRequest_1.default)(course_validation_1.updateCourseSchema), course_controller_1.CourseController.updateCourse);
