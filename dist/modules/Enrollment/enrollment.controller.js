...
const getMyEnrollments = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const userId = req.user._id;
    const enrolledCourse = yield enrollment_modal_1.Enrollment.findOne({ userId });
    const enrolledCourseIds = enrolledCourse === null || enrolledCourse === void 0 ? void 0 : enrolledCourse.courseIds;
    const result = yield course_model_1.Course.find({ _id: { $in: enrolledCourseIds } });
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const enrolledCourse = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const enrolledCourse = yield enrollment_modal_1.Enrollment.find();
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
exports.EnrollmentController = { getMyEnrollments, enrollCourse: exports.enrollCourse, enrolledCourse };
